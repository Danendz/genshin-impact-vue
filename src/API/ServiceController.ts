...
type allowedCharacterCategories = "attributes" | "weapons" | "artifacts" | "constellation" | "talents" | "profile"
...
export default abstract class ServiceController {
    ...
    //get item by name
    public async getByName<T extends fetchingItemsType>(name: string, category?: allowedCharacterCategories): Promise<T | ErrorMessages.NOT_FOUND> {
